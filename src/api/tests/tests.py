...
class TestAPI(TestCase):
    def setUp(self):
        ...
        self.quiz = sample_quiz(level=1, title="test", description="TEST")
        self.question = sample_question(quiz=self.quiz, order_number=1)
        self.user = get_user_model().objects.create(email="test@customer.com")
    ...
    def test_question_detail(self):
        ...
        self.assertEqual(result.data, {"id": 1, "order_number": 1, "text": "Some text", "choices": []})
